...
class ThinkBack(object):
    ...
    def get_cycles2(self):
        """
        Get cycle in the top of each option chain
        weekly not more JAN1 or FEB2, direct 16 JAN 09
        16 JAN 09  (14)  100 (CDL 7; US$ 4.06)
        21 JAN 09  (11)  19/100 (US$ 3601.92)
        9 JAN 15  (444)  150 (DDD 150)
        :return:
        """
        cycles = []
    ...
    def get_cycles(self):
        ...
        :return: list
        """
        # todo: update new csv with "20 MAR 10  (74)  100"
