...
from opinion.group.market.models import MarketSentiment, MarketReview, MarketMovement
...
def market_profile(request, date):
    ...
    try:
        macro_valuation = MarketReview.objects.get(date=date)
    except ObjectDoesNotExist:
        macro_valuation = MarketReview.objects.latest('date')
